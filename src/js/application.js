...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('box,grab,value,set,browser_object,id,require,[],style,text,image,touch,home,alert,matrix,color,attached,data,unbind,cell,each,materials,==,to_s,delete,web,video,send,/,height,width,resize,view,*,on,reset_size');
...
;
  ...
  $def(self, '$clear_page', function $$clear_page() {
    ...
    $send(sections.$cell(0).$materials(), 'each', [], function $$6(child){var self = $$6.$$s == null ? this : $$6.$$s;
    ...
    $send(sections.$cell(1).$materials(), 'each', [], function $$7(child){var self = $$7.$$s == null ? this : $$7.$$s;
    ...
    $send(sections.$cell(2).$materials(), 'each', [], function $$8(child){var self = $$8.$$s == null ? this : $$8.$$s;
    ...
    return $send(sections.$cell(3).$materials(), 'each', [], function $$9(child){var self = $$9.$$s == null ? this : $$9.$$s;
