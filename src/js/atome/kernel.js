...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.7.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.3.6.4")
  })($nesting[0], null, $nesting)
};

Opal.modules["atome/genesis/genesis"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $def = Opal.def, $hash2 = Opal.hash2, $truthy = Opal.truthy, $send = Opal.send, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('new,[],nil?,add_to_particle_list,auto_render_generator,new_particle,to_proc,additional_particle_methods,add_to_atome_list,new_atome,each,renderer_list,build_render,new_render_engine,add_sanitizer_method,to_sym,add_optional_method');
...
Opal.modules["atome/kernel/essentials"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $hash2 = Opal.hash2, $slice = Opal.slice, $send = Opal.send, $def = Opal.def, $hash = Opal.hash, $assign_ivar_val = Opal.assign_ivar_val, $eqeqeq = Opal.eqeqeq, $truthy = Opal.truthy, $return_ivar = Opal.return_ivar, $eqeq = Opal.eqeq, $assign_ivar = Opal.assign_ivar, $return_val = Opal.return_val, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return (function(self, $parent_nesting) {
      ...
      $def(self, '$app_identity', $assign_ivar_val("app_identity", 3));
...
Opal.modules["atome/kernel/batch"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy, $def = Opal.def, $slice = Opal.slice, $to_a = Opal.to_a, $assign_ivar = Opal.assign_ivar, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('each,value,is_a?,instance_exec,to_proc,[],length,atomes,add_to_atomes,send,dispatch');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Batch');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.id = $proto.data = nil;
    ...
    $def(self, '$each', function $$each() {
      ...
      ;
      return $send(self.$value(), 'each', [], function $$1(val){var self = $$1.$$s == null ? this : $$1.$$s;
    ...
    $def(self, '$initialize', function $$initialize(params) {
      ...
      self.id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : ("batch_" + ($$('Universe').$atomes().$length())));
      return $$('Universe').$add_to_atomes(self.id, self);
    });
    
    $def(self, '$dispatch', function $$dispatch(method, $a) {
      var block = $$dispatch.$$p || nil, $post_args, args, self = this;
      ...
      args = $post_args;
      return $send(self.data, 'each', [], function $$2(atome_found){
        
        if (atome_found == null) atome_found = nil;
        return $send(atome_found, 'send', [method].concat($to_a(args)), block.$to_proc());});
    }, -2);
    
    $def(self, '$color', function $$color(args) {
      var block = $$color.$$p || nil, self = this;

      $$color.$$p = null;
      
      ;
      return $send(self, 'dispatch', ["color", args], block.$to_proc());
    });
    
    $def(self, '$shadow', function $$shadow(args) {
      var block = $$shadow.$$p || nil, self = this;
    ...
    $def(self, '$method_missing', function $$method_missing(method, $a) {
      ...
      $post_args = $slice(arguments, 1);
      args = $post_args;
      return $send(self, 'dispatch', [method, args], block.$to_proc());
    }, -2);
    return $def(self, '$data', $assign_ivar("data"));
  })($nesting[0], null, $nesting)
};

Opal.modules["atome/helpers/essentials"] = function(Opal) {/* Generated by Opal 1.7.1 */
  ...
  return (function($base, $parent_nesting) {
    ...
    self.default_params = $hash2(["render_engines", "collector", "animation", "element", "matrix", "box", "circle", "shape", "text", "drm", "shadow", "color"], {"render_engines": ["browser"], "collector": $hash2(["type", "renderers", "children"], {"type": "element", "renderers": [], "children": []}), "animation": $hash2(["type", "children"], {"type": "animation", "children": []}), "element": $hash2(["type", "renderers", "children"], {"type": "element", "renderers": [], "children": []}), "matrix": $hash2(["renderers", "id", "type", "parents", "width", "height", "attached", "children", "left", "top", "clones", "preset"], {"renderers": [], "id": "", "type": "shape", "parents": [], "width": 99, "height": 99, "attached": ["matrix_color"], "children": [], "left": 100, "top": 100, "clones": [], "preset": "matrix"}), "box": $hash2(["renderers", "id", "type", "parents", "width", "height", "attached", "children", "left", "top", "clones", "preset"], {"renderers": [], "id": "", "type": "shape", "parents": [], "width": 99, "height": 99, "attached": ["box_color"], "children": [], "left": 100, "top": 100, "clones": [], "preset": "box"}), "circle": $hash2(["renderers", "id", "type", "parents", "width", "height", "smooth", "attached", "children", "left", "top", "clones", "preset"], {"renderers": [], "id": "", "type": "shape", "parents": [], "width": 99, "height": 99, "smooth": "100%", "attached": ["circle_color"], "children": [], "left": 100, "top": 100, "clones": [], "preset": "circle"}), "shape": $hash2(["renderers", "id", "type", "parents", "width", "height", "attached", "children", "left", "top", "clones"], {"renderers": [], "id": "", "type": "shape", "parents": [], "width": 99, "height": 99, "attached": ["view_color"], "children": [], "left": 100, "top": 100, "clones": []}), "text": $hash2(["renderers", "id", "type", "parents", "visual", "attached", "children", "data", "width", "height", "clones"], {"renderers": [], "id": "", "type": "text", "parents": ["view"], "visual": $hash2(["size"], {"size": 25}), "attached": ["text_color"], "children": [], "data": "this is a text sample", "width": 199, "height": 33, "clones": []}), "drm": $hash2(["type"], {"type": "drm"}), "shadow": $hash2([], {}), "color": $hash2([], {})});
...
Opal.modules["atome/renderers/renderer"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $send = Opal.send, $def = Opal.def, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('private,instance_variable_get,[],each,send,to_proc');
  return (function($base, $super) {
    var self = $klass($base, $super, 'Atome');
    ...
    self.$private();
    return $def(self, '$rendering', function $$rendering(element) {
      var user_proc = $$rendering.$$p || nil, self = this, params = nil, render_engines = nil;
...
Opal.modules["atome/helpers/color_helper/color/rgb/metallic"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color/rgb/colors"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color/rgb"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color/cmyk"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color/grayscale"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color/hsl"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color/yiq"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color/css"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/helpers/color_helper/color"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $def = Opal.def, $hash2 = Opal.hash2, $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('[],atomes,box,grab,to_proc,circle,matrix,define_method,send');
  ...
  return $def(self, '$create_method_at_object_level', function $$create_method_at_object_level(element) {
    ...
    return $send($$('Object'), 'define_method', [element], function $$1(params){var user_proc = $$1.$$p || nil, self = $$1.$$s == null ? this : $$1.$$s;
      ...
      return $send(self.$grab("view"), 'send', [element, params], user_proc.$to_proc());}, {$$s: self})
  });
};

Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $hash2 = Opal.hash2, $send = Opal.send, $truthy = Opal.truthy, $def = Opal.def, $eqeq = Opal.eqeq, $slice = Opal.slice, $hash = Opal.hash, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('include,private,each_value,[]=,create_particle,set_type,[],collapse,define_method,==,is_a?,instance_exec,to_proc,sanitize,send,get_particle,particle_creation,create_atome,default_params,length,atomes,value,id,merge,atome_creation_pre_treatment,get_atome,create_method_at_object_level,instance_variable_get,get_optional_method,public,attr_accessor,attr_reader,security_pass,store_code_bloc,instance_variable_set,run_optional_proc,to_sym,rendering,broadcasting,store_value,new,value=,real_atome=,property=,user_proc=,connected');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$initialize', function $$initialize(atomes) {
      ...
      return $send(atomes, 'each_value', [], function $$1(elements){var self = $$1.$$s == null ? this : $$1.$$s;
        ...
        self.atome = elements;
        self.$create_particle("type", true, true);
        self.$set_type(self.atome['$[]']("type"));
        return self.$collapse();}, {$$s: self});
    }, -1);
    ...
    $def(self, '$atome_initializer', function $$atome_initializer(element, params) {
      var self = this, temp_default = nil, $ret_or_1 = nil, generated_render = nil, generated_id = nil, generated_parents = nil, generated_children = nil;

      
      if (params == null) params = $hash2([], {});
      temp_default = ($truthy(($ret_or_1 = $$('Essentials').$default_params()['$[]'](element))) ? ($ret_or_1) : ($hash2([], {})));
      generated_render = ($truthy(($ret_or_1 = params['$[]']("renderers"))) ? ($ret_or_1) : ([]));
      generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : ("" + (element) + "_" + ($$('Universe').$atomes().$length())));
      generated_parents = ($truthy(($ret_or_1 = params['$[]']("parents"))) ? ($ret_or_1) : ([self.$id().$value()]));
      generated_children = ($truthy(($ret_or_1 = params['$[]']("children"))) ? ($ret_or_1) : ([]));
    ...
    $def(self, '$run_optional_proc', function $$run_optional_proc(proc_name, $a, $b) {
      var user_proc = $$run_optional_proc.$$p || nil, $post_args, atome, element, self = this, params = nil, option_found = nil;
      ...
      element = $post_args.shift();if (element == null) element = nil;
      params = self.$instance_variable_get("@" + (element));
    ...
    $def(self, '$particle_creation', function $$particle_creation(element, params, store, render) {
      ...
      $send(self, 'run_optional_proc', [(("pre_render_") + (self.atome['$[]']("type"))).$to_sym(), self, element], user_proc.$to_proc());
      $send(self, 'run_optional_proc', [(("pre_render_") + (element)).$to_sym(), self, element], user_proc.$to_proc());
      if ($truthy(render)) {
        $send(self, 'rendering', [element], user_proc.$to_proc())
      };
      $send(self, 'run_optional_proc', [(("post_render_") + (self.atome['$[]']("type"))).$to_sym(), self, element], user_proc.$to_proc());
      $send(self, 'run_optional_proc', [(("post_render_") + (element)).$to_sym(), self, element], user_proc.$to_proc());
    ...
    $def(self, '$get_particle', function $$get_particle(element) {
      ...
      $send(self, 'run_optional_proc', [(("pre_get_") + (self.atome['$[]']("type"))).$to_sym(), "virtual_atome"], user_proc.$to_proc());
      $send(self, 'run_optional_proc', [(("pre_get_") + (element)).$to_sym(), self, "virtual_atome"], user_proc.$to_proc());
    ...
    $def(self, '$get_atome', function $$get_atome(element) {
      ...
      virtual_atome['$value='](self.atome['$[]'](element));
      virtual_atome;
      return "it should contain the atome not : " + (element);
    });
    ...
    $def(self, '$create_atome', function $$create_atome(new_atome) {
      ...
      return $send($$('Atome'), 'define_method', ["set_" + (new_atome)], function $$7(params){var user_proc = $$7.$$p || nil;
        ...
        ;
        if (params == null) params = nil;
        return $send($$('Atome'), 'new', [$hash(new_atome, params)], user_proc.$to_proc());})
    });
    return $$('Universe').$connected();
  })($nesting[0], null, $nesting)
};

Opal.modules["atome/helpers/callbacks"] = function(Opal) {/* Generated by Opal 1.7.1 */
  ...
  Opal.add_stubs('private,attr_accessor,public,is_a?,instance_exec,to_proc,[]=,each_value,<,[],>=,play_active_proc,browser_object,style,==,atome');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.atome = $proto.drag_start_proc = $proto.drag_move_proc = $proto.drag_end_proc = $proto.sort_proc = $proto.animation_start_proc = $proto.animation_stop_proc = nil;
...
Opal.modules["atome/genesis/generators/atome"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_atome,build_sanitizer,[],found_parents_and_renderers,==,length,atomes,instance_of?,create_color_hash,merge!,[]=,atome,default_params,value,id,merge,atome_common');
  ...
  $send(generator, 'build_sanitizer', ["color"], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s, parent_found = nil, render_found = nil, default_params = nil, new_params = nil;
    ...
    if ($eqeq(parent_found, ["view"])) {
      parent_found = ["user_view"]
    };
  ...
  $send(generator, 'build_sanitizer', ["video"], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s, parent_found = nil, render_found = nil, default_params = nil;
    ...
    return default_params['$merge!'](params);}, {$$s: self});
  ...
  $send(generator, 'build_sanitizer', ["element"], function $$4(params){var self = $$4.$$s == null ? this : $$4.$$s, parent_found = nil, render_found = nil, default_params = nil;

    
    if (params == null) params = nil;
    parent_found = self.$found_parents_and_renderers()['$[]']("parent");
    render_found = [];
    default_params = $hash2(["renderers", "id", "type", "parents", "data"], {"renderers": render_found, "id": "element_" + ($$('Universe').$atomes().$length()), "type": "element", "parents": parent_found, "data": ""});
    return default_params['$merge!'](params);}, {$$s: self});
  generator.$build_atome("collector");
  $send(generator, 'build_sanitizer', ["web"], function $$5(params){var self = $$5.$$s == null ? this : $$5.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parents = nil, temp_default = nil;
  ...
  $send(generator, 'build_sanitizer', ["animation"], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s, default_renderer = nil, atome_type = nil, generated_render = nil, $ret_or_1 = nil, generated_id = nil, generated_parents = nil, generated_children = nil;
    ...
    generated_children = ($truthy(($ret_or_1 = params['$[]']("children"))) ? ($ret_or_1) : ([]));
    params = self.$atome_common(atome_type, generated_id, generated_render, generated_parents, generated_children, params);
    return params;}, {$$s: self});
  $send(generator, 'build_sanitizer', ["image"], function $$7(params){var self = $$7.$$s == null ? this : $$7.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parents = nil, temp_default = nil;
    ...
    params = temp_default.$merge(params);
    return params;}, {$$s: self});
  return $send(generator, 'build_sanitizer', ["text"], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s, default_renderer = nil, atome_type = nil, generated_render = nil, $ret_or_1 = nil, generated_id = nil, generated_parents = nil, generated_children = nil;
...
Opal.modules["atome/presets/atome"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $hash2 = Opal.hash2, $def = Opal.def, $send = Opal.send, $hash = Opal.hash, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[],default_params,[]=,concat,merge,length,atomes,value,id,atome_common,new,to_proc');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$atome_common', function $$atome_common(atome_type, generated_id, generated_render, generated_parents, generated_children, params) {
    ...
    $def(self, '$box', function $$box(params) {
      var bloc = $$box.$$p || nil, self = this, default_renderer = nil, atome_type = nil, generated_render = nil, $ret_or_1 = nil, generated_id = nil, generated_parents = nil, generated_children = nil;
    ...
    return $def(self, '$circle', function $$circle(params) {
      var bloc = $$circle.$$p || nil, self = this, default_renderer = nil, atome_type = nil, generated_render = nil, $ret_or_1 = nil, generated_id = nil, generated_parents = nil, generated_children = nil;
...
Opal.modules["atome/genesis/generators/communication"] = Opal.return_val(Opal.nil); /* Generated by Opal 1.7.1 */

Opal.modules["atome/genesis/generators/effect"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/genesis/generators/event"] = function(Opal) {/* Generated by Opal 1.7.1 */
  ...
  $send(generator, 'build_particle', ["play"], function $$1(){var $a, self = $$1.$$s == null ? this : $$1.$$s;
    if (self.atome == null) self.atome = nil;

    return ($a = ["pause", "false"], $send(self.atome, '[]=', $a), $a[$a.length - 1])}, {$$s: self});
  generator.$build_particle("time");
  $send(generator, 'build_particle', ["pause"], function $$2(){var $a, self = $$2.$$s == null ? this : $$2.$$s;
    if (self.atome == null) self.atome = nil;
  ...
  $send(generator, 'build_sanitizer', ["drag"], function $$3(params){
    ...
    return params;});
  $send(generator, 'build_particle', ["sort"], function $$4(_value, sort_proc){var self = $$4.$$s == null ? this : $$4.$$s;
  ...
  $send(generator, 'build_option', ["pre_render_start"], function $$5(_value, user_proc){var self = $$5.$$s == null ? this : $$5.$$s;
  ...
  $send(generator, 'build_option', ["pre_render_stop"], function $$6(_value, user_proc){var self = $$6.$$s == null ? this : $$6.$$s;
...
Opal.modules["atome/genesis/generators/geometry"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $rb_divide = Opal.rb_divide, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt, $rb_times = Opal.rb_times, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_particle,[],atome,/,>,width,height,*');
  
  generator = $$('Genesis').$generator();
  generator.$build_particle("width");
  generator.$build_particle("height");
  return $send(generator, 'build_particle', ["size"], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s, atome_width = nil, atome_height = nil, aspect_ratio = nil;
...
Opal.modules["atome/genesis/generators/identity"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $truthy = Opal.truthy, $hash2 = Opal.hash2, $neqeq = Opal.neqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_particle,build_option,each,instance_of?,value,grab,family,<<,[],atome,[]=,refresh,build_sanitizer,!=,update_atome_id,add_to_atomes,each_with_index,particles,merge,new,monitor,send');
  
  generator = $$('Genesis').$generator();
  generator.$build_particle("type");
  generator.$build_particle("parents");
  generator.$build_particle("children");
  $send(generator, 'build_option', ["pre_render_parents"], function $$1(parents_ids){var self = $$1.$$s == null ? this : $$1.$$s;

    
    if (parents_ids == null) parents_ids = nil;
    return $send(parents_ids, 'each', [], function $$2(parents_id){var self = $$2.$$s == null ? this : $$2.$$s, parents_found = nil;
      ...
      self.$family(parents_id);
      return parents_found.$atome()['$[]']("children")['$<<'](self.$atome()['$[]']("id"));}, {$$s: self});}, {$$s: self});
  $send(generator, 'build_option', ["pre_render_children"], function $$3(children_ids){var self = $$3.$$s == null ? this : $$3.$$s;

    
    if (children_ids == null) children_ids = nil;
    return $send(children_ids, 'each', [], function $$4(child_id){var $a, self = $$4.$$s == null ? this : $$4.$$s, child_found = nil, parents_found = nil;
      if (self.atome == null) self.atome = nil;
      ...
      return ($a = ["parents", [parents_found]], $send(child_found.$atome(), '[]=', $a), $a[$a.length - 1]);}, {$$s: self});}, {$$s: self});
  generator.$build_particle("family", $hash2(["render", "store"], {"render": true, "store": false}));
  $send(generator, 'build_particle', ["link"], function $$5(child_id){var self = $$5.$$s == null ? this : $$5.$$s, child_found = nil;
    if (self.atome == null) self.atome = nil;
    ...
    return child_found.$refresh();}, {$$s: self});
  generator.$build_particle("id");
  $send(generator, 'build_sanitizer', ["id"], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s;
    if (self.atome == null) self.atome = nil;
  ...
  $send(generator, 'build_option', ["pre_render_attach"], function $$7(parents_ids){var self = $$7.$$s == null ? this : $$7.$$s;

    
    if (parents_ids == null) parents_ids = nil;
    return $send(parents_ids, 'each', [], function $$8(parents_id){var self = $$8.$$s == null ? this : $$8.$$s, parents_found = nil;
      ...
      return parents_found.$atome()['$[]']("attached")['$<<'](self.$atome()['$[]']("id"));}, {$$s: self});}, {$$s: self});
  $send(generator, 'build_option', ["pre_render_attached"], function $$9(children_ids){var self = $$9.$$s == null ? this : $$9.$$s;

    
    if (children_ids == null) children_ids = nil;
    return $send(children_ids, 'each', [], function $$10(child_id){var $a, self = $$10.$$s == null ? this : $$10.$$s, child_found = nil, parents_found = nil;
      if (self.atome == null) self.atome = nil;
  ...
  generator.$build_particle("intricate", $hash2(["type"], {"type": "array"}));
  return $send(generator, 'build_particle', ["clones"], function $$11(clones_found){var self = $$11.$$s == null ? this : $$11.$$s;

    
    if (clones_found == null) clones_found = nil;
    return $send(clones_found, 'each_with_index', [], function $$12(clone_found, index){var $a, self = $$12.$$s == null ? this : $$12.$$s, particles_intricated = nil, $ret_or_1 = nil, clone_id = nil, original_id = nil, cloned_atome = nil;
      ...
      return $send(cloned_atome, 'monitor', [$hash2(["atomes", "particles"], {"atomes": [original_id], "particles": particles_intricated})], function $$13(_atome, particle, value){
...
Opal.modules["atome/genesis/generators/material"] = function(Opal) {/* Generated by Opal 1.7.1 */
  ...
  generator = $$('Genesis').$generator();
  $send(generator, 'build_particle', ["red"], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

    return self}, {$$s: self});
  $send(generator, 'build_particle', ["green"], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;

    return self}, {$$s: self});
  $send(generator, 'build_particle', ["blue"], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;

    return self}, {$$s: self});
  $send(generator, 'build_particle', ["alpha"], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;

    return self}, {$$s: self});
  $send(generator, 'build_particle', ["diffusion"], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;
  ...
  $send(generator, 'build_option', ["pre_render_style"], function $$6(styles_send, _user_proc){var self = $$6.$$s == null ? this : $$6.$$s;
  ...
  return $send(generator, 'build_particle', ["remove"], function $$8(particle_to_remove){var self = $$8.$$s == null ? this : $$8.$$s;
...
Opal.modules["atome/genesis/generators/spatial"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/genesis/generators/time"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $hash2 = Opal.hash2, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_particle');
  
  generator = $$('Genesis').$generator();
  return generator.$build_particle("markers", $hash2(["type"], {"type": "hash"}));
};

Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_particle,[],is_a?,instance_exec,to_proc,==,delete,grab,instance_of?,each,[]=,atome,send,to_s,split,union,renderer_list');
  ...
  $send(generator, 'build_particle', ["delete"], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s;
    if (self.atome == null) self.atome = nil;

    
    if (params == null) params = nil;
    if ($eqeq(params, true)) {
      return $$('Universe').$delete(self.atome['$[]']("id"))
    } else if ($truthy(params['$[]']("id"))) {
      return self.$grab(params['$[]']("id")).$delete(true)
    } else if ($truthy(params['$instance_of?']($$('Hash')))) {
      return $send(params, 'each', [], function $$3(param, value){var $a, self = $$3.$$s == null ? this : $$3.$$s;
  ...
  $send(generator, 'build_particle', ["schedule"], function $$4(date, proc){var self = $$4.$$s == null ? this : $$4.$$s, delimiters = nil, format_date = nil;
    ...
    return $send($$('Universe').$renderer_list(), 'each', [], function $$5(renderer){var self = $$5.$$s == null ? this : $$5.$$s;

      
      if (renderer == null) renderer = nil;
      return $send(self, 'send', ["" + (renderer) + "_schedule", format_date], proc.$to_proc());}, {$$s: self});}, {$$s: self});
  $send(generator, 'build_particle', ["read"], function $$6(file, proc){var self = $$6.$$s == null ? this : $$6.$$s;

    
    if (file == null) file = nil;
    if (proc == null) proc = nil;
    return $send($$('Universe').$renderer_list(), 'each', [], function $$7(renderer){var self = $$7.$$s == null ? this : $$7.$$s;
  ...
  return generator.$build_particle("relations", $hash2(["type"], {"type": "hash"}));
};

Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $send = Opal.send, $eqeq = Opal.eqeq, $def = Opal.def, $return_val = Opal.return_val, $truthy = Opal.truthy, $hash2 = Opal.hash2, $hash = Opal.hash, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('private,each,==,send,get_sanitizer_method,is_a?,instance_exec,to_proc,now,geolocation,instance_variable_get,each_value,include?,[],public,atome,[]=,grab,length,merge,attr_accessor,instance_variable_set,value,<<,real_atome,property,store_code_bloc,particle_list,collapse,atomes,id,atome_common,new,class,collector,data');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$monitor', function $$monitor(params) {
      var proc_monitoring = $$monitor.$$p || nil, self = this, $logical_op_recvr_tmp_1 = nil, $ret_or_1 = nil;
      ...
      if ($truthy(params)) {
        ...
        $logical_op_recvr_tmp_1 = self.$atome();
        if ($truthy(($ret_or_1 = $logical_op_recvr_tmp_1['$[]']("monitor")))) {
          $ret_or_1
        } else {
          $logical_op_recvr_tmp_1['$[]=']("monitor", $hash2([], {}))
        };;
        return $send(params['$[]']("atomes"), 'each', [], function $$3(atome_id){var $a, self = $$3.$$s == null ? this : $$3.$$s, target_broadcaster = nil, monitor_id = nil;
          ...
          self.$atome()['$[]']("monitor")['$[]='](monitor_id, params.$merge($hash2(["code"], {"code": proc_monitoring})));
          return ($a = [monitor_id, $hash2(["particles", "code"], {"particles": params['$[]']("particles"), "code": proc_monitoring})], $send(target_broadcaster, '[]=', $a), $a[$a.length - 1]);}, {$$s: self});
      } else {
    ...
    $def(self, '$add', function $$add(particles) {
      ...
      ;
      return $send(particles, 'each', [], function $$7(particle, value){var self = $$7.$$s == null ? this : $$7.$$s, particle_type = nil;

        
        if (particle == null) particle = nil;
        if (value == null) value = nil;
        particle_type = $$('Universe').$particle_list()['$[]'](particle);
        return $send(self, 'send', ["add_to_" + (particle_type), particle, value], user_proc.$to_proc());}, {$$s: self});
    });
    ...
    $def(self, '$collector', function $$collector(params) {
      var bloc = $$collector.$$p || nil, self = this, atome_type = nil, generated_render = nil, $ret_or_1 = nil, generated_id = nil, generated_parents = nil, generated_children = nil;
      ...
      generated_children = ($truthy(($ret_or_1 = params['$[]']("children"))) ? ($ret_or_1) : ([]));
      params = self.$atome_common(atome_type, generated_id, generated_render, generated_parents, generated_children, params);
      return $send($$('Batch'), 'new', [$hash(atome_type, params)], bloc.$to_proc());
    }, -1);
    ...
    $def(self, '$[]', function $Atome_$$$9(range) {
      var self = this, collector_object = nil, collected_atomes = nil;

      if ($eqeq(self.$value()['$[]'](range).$class(), $$('Atome'))) {
        return self.$value()['$[]'](range)
      } else if ($eqeq(self.$value()['$[]'](range).$class(), $$('Array'))) {
        
        collector_object = $$('Object').$collector($hash2([], {}));
        collected_atomes = [];
        $send(self.$value()['$[]'](range), 'each', [], function $$10(atome_found){
          
          if (atome_found == null) atome_found = nil;
          return collected_atomes['$<<'](atome_found);});
    ...
    return $def(self, '$set', function $$set(params) {
      var self = this;
...
Opal.modules["atome/renderers/browser/effect"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/event"] = function(Opal) {/* Generated by Opal 1.7.1 */
  ...
  $send(generator, 'build_render', ["browser_touch"], function $$1(value, proc){var self = $$1.$$s == null ? this : $$1.$$s, atome_id = nil;
    ...
    return $$('BrowserHelper').$send("browser_touch_" + (value), atome_id, proc);}, {$$s: self});
  ...
  $send(generator, 'build_render', ["browser_drag"], function $$9(options, proc){var self = $$9.$$s == null ? this : $$9.$$s;

    
    if (options == null) options = nil;
    if (proc == null) proc = nil;
    return $send(options, 'each', [], function $$10(method, params){var self = $$10.$$s == null ? this : $$10.$$s, atome_id = nil;
      if (self.atome == null) self.atome = nil;
  ...
  $send(generator, 'build_render', ["browser_sort"], function $$11(options, _proc){var self = $$11.$$s == null ? this : $$11.$$s;
    if (self.atome == null) self.atome = nil;
  ...
  return $send(generator, 'build_render', ["browser_unbind"], function $$12(options, _proc){var self = $$12.$$s == null ? this : $$12.$$s, id_found = nil;
...
Opal.modules["atome/renderers/browser/geometry"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/browser/identity"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $eqeq = Opal.eqeq, $neqeq = Opal.neqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_render,==,inner_html,sub,id,inner_html=,!=,[],id=,browser_object,send,user_proc,each');
  ...
  $send(generator, 'build_render', ["browser_family"], function $$3(parents_found){var self = $$3.$$s == null ? this : $$3.$$s;
    if (self.browser_type == null) self.browser_type = nil;
    if (self.browser_object == null) self.browser_object = nil;
    if (self.atome == null) self.atome = nil;
    ...
    return $$('BrowserHelper').$send("browser_attach_" + (self.browser_type), parents_found, self.browser_object, self.atome);}, {$$s: self});
  return $send(generator, 'build_render', ["browser_attach"], function $$4(parents_found){var self = $$4.$$s == null ? this : $$4.$$s;

    
    if (parents_found == null) parents_found = nil;
    return $send(parents_found, 'each', [], function $$5(parent_found){var self = $$5.$$s == null ? this : $$5.$$s;
      if (self.browser_type == null) self.browser_type = nil;
      if (self.browser_object == null) self.browser_object = nil;
      if (self.atome == null) self.atome = nil;
...
Opal.modules["atome/renderers/browser/material"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $rb_times = Opal.rb_times, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_render,*,[]=,[],send,value_parse,style,browser_object,==,attributes');
...
Opal.modules["atome/renderers/browser/spatial"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/atome"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/utility"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
  ...
  $send(generator, 'build_render', ["browser_clear"], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;
    ...
    $send(self.atome['$[]']("children"), 'each', [], function $$3(child_found){var $a, self = $$3.$$s == null ? this : $$3.$$s;
      ...
      return ($a = self.$grab(child_found).$browser_object(), ($a === nil || $a == null) ? nil : $a.$remove());}, {$$s: self});
...
Opal.modules["atome/renderers/browser/time"] = Opal.return_val(Opal.nil); /* Generated by Opal 1.7.1 */

Opal.modules["atome/renderers/browser/helpers/browser_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $module = Opal.module, $defs = Opal.defs, $truthy = Opal.truthy, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('window,append_to,[],browser_document,add_class,instance_of?');
  return (function($base, $parent_nesting) {
...
Opal.modules["atome/renderers/browser/helpers/animation_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/helpers/color_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/helpers/drag_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/helpers/effect_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/helpers/event_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/helpers/image_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/helpers/shadow_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $module = Opal.module, $send = Opal.send, $rb_times = Opal.rb_times, $defs = Opal.defs, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/renderers/browser/helpers/shape_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $module = Opal.module, $send = Opal.send, $defs = Opal.defs, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/renderers/browser/helpers/text_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $module = Opal.module, $send = Opal.send, $defs = Opal.defs, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[]=,value_parse,style,text=,browser_object');
  return (function($base, $parent_nesting) {
    var self = $module($base, 'BrowserHelper');
...
Opal.modules["atome/renderers/browser/helpers/video_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/browser/helpers/web_helper"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $module = Opal.module, $send = Opal.send, $defs = Opal.defs, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/renderers/browser/browser"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/html/effect"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/html/event"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/geometry"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/identity"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/spatial"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/atome"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/html/utility"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/html"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/headless/utility"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/headless/headless"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/renderers/server/utility"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/server/server"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var self = Opal.top, nil = Opal.nil;
...
Opal.modules["atome/extensions/matrix"] = function(Opal) {/* Generated by Opal 1.7.1 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $send = Opal.send, $hash2 = Opal.hash2, $def = Opal.def, $rb_times = Opal.rb_times, $rb_divide = Opal.rb_divide, $rb_minus = Opal.rb_minus, $rb_plus = Opal.rb_plus, $hash = Opal.hash, $rb_lt = Opal.rb_lt, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('instance_of?,each,content,[],particles,width,height,left,top,[]=,parents,id,collector,grab,<<,data,*,get_column_or_row,is_a?,instance_exec,to_proc,element,merge,/,-,+,each_with_index,value,zero?,length,hide,take,include?,columns,rows,times,children,width=,height=,fusion,divide,set,matrix_sanitizer,delete,color,shadow,default_params,atomes,atome_common,new,instance_variable_set,box,attached,apply_style,format_matrix,<,to_a');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.cell_content = $proto.columns = $proto.rows = $proto.exceptions = $proto.matrix_width = $proto.matrix_height = $proto.margin = nil;
    
    
    $def(self, '$content', function $$content(items) {
      var self = this, w_found = nil, h_found = nil, l_found = nil, t_found = nil, i_found = nil, current_w_found = nil, current_h_found = nil, current_l_found = nil, current_t_found = nil, $ret_or_1 = nil;

      
      if (items == null) items = nil;
      if ($truthy(items['$instance_of?']($$('Array')))) {
        return $send(items, 'each', [], function $$1(item){var self = $$1.$$s == null ? this : $$1.$$s;

          
          if (item == null) item = nil;
          return self.$content(item);}, {$$s: self})
      } else if ($truthy(items['$instance_of?']($$('Atome')))) {
        ...
        current_w_found = self.$width();
        current_h_found = self.$height();
        current_l_found = self.$left();
        current_t_found = self.$top();
        self.cell_content = ($truthy(($ret_or_1 = self.cell_content)) ? ($ret_or_1) : ($hash2([], {})));
        self.cell_content['$[]='](i_found, $hash2(["width_ratio", "height_ratio", "top_ratio", "left_ratio"], {"width_ratio": 1, "height_ratio": 1, "top_ratio": 1, "left_ratio": 1}));
        return items.$parents([self.$id()]);
      } else {
    ...
    $def(self, '$cells', function $$cells(cell_nb) {
      ...
      collector_object = self.$collector($hash2([], {}));
      collected_atomes = [];
      $send(cell_nb, 'each', [], function $$2(cell_found){var self = $$2.$$s == null ? this : $$2.$$s, atome_found = nil;

        
        if (cell_found == null) cell_found = nil;
        atome_found = self.$grab("" + (self.$id()) + "_" + (cell_found));
        return collected_atomes['$<<'](atome_found);}, {$$s: self});
      collector_object.$data(collected_atomes);
      return collector_object;
    });
      ...
      if ($truthy(params['$[]']("columns"))) {
        ...
        return $send(params['$[]']("columns"), 'each', [], function $$5(column_to_alter, value){var self = $$5.$$s == null ? this : $$5.$$s, cell_height = nil, cells_in_column = nil, cells_to_alter = nil;
          ...
          return $send(cells_to_alter, 'each_with_index', [], function $$6(cell_nb, index){var self = $$6.$$s == null ? this : $$6.$$s, current_cell = nil;
            ...
            if (cell_nb == null) cell_nb = nil;
            if (index == null) index = nil;
            current_cell = self.$grab("" + (self.$id().$value()) + "_" + (cell_nb));
        ...
        return $send(params['$[]']("columns"), 'each', [], function $$9(column_to_alter, value){var self = $$9.$$s == null ? this : $$9.$$s, cells_in_column = nil, cells_to_alter = nil;
          ...
          return $send(cells_in_column, 'each_with_index', [], function $$10(cell_nb, index){var self = $$10.$$s == null ? this : $$10.$$s, current_cell = nil;
            ...
            if ($truthy(cells_to_alter['$include?'](cell_nb))) {
              ...
              return current_cell.$top($rb_plus($rb_times(current_cell.$height().$value(), index), $rb_times(self.margin, $rb_plus(index, 1))));
            } else {
              return current_cell.$hide(true)
            };}, {$$s: self});}, {$$s: self})
      } else {
        return $send(params['$[]']("rows"), 'each', [], function $$11(row_to_alter, value){var self = $$11.$$s == null ? this : $$11.$$s, cells_in_row = nil, cells_to_alter = nil;
          ...
          return $send(cells_in_row, 'each_with_index', [], function $$12(cell_nb, index){var self = $$12.$$s == null ? this : $$12.$$s, current_cell = nil;
            ...
            if ($truthy(cells_to_alter['$include?'](cell_nb))) {
              ...
              return current_cell.$left($rb_plus($rb_times(current_cell.$width().$value(), index), $rb_times(self.margin, $rb_plus(index, 1))));
            } else {
              return current_cell.$hide(true)
            };}, {$$s: self});}, {$$s: self})
      };
    ...
    $def(self, '$format_matrix', function $$format_matrix(matrix_id, matrix_width, matrix_height, nb_of_rows, nb_of_cols, margin, exceptions) {
      var self = this, cell_width = nil, cell_height = nil, ratio = nil, i = nil, number_of_cells = nil;
      ...
      $send(nb_of_rows, 'times', [], function $$13(row_index){var self = $$13.$$s == null ? this : $$13.$$s;
        ...
        return $send(nb_of_cols, 'times', [], function $$14(col_index){var self = $$14.$$s == null ? this : $$14.$$s, x = nil, y = nil, current_cell = nil;
          ...
          $send(current_cell.$children(), 'each', [], function $$15(child){var self = $$15.$$s == null ? this : $$15.$$s;

            
            if (child == null) child = nil;
            self.$grab(child).$width(cell_width);
            return self.$grab(child).$height(cell_width);}, {$$s: self});
          current_cell['$width='](cell_width);
          current_cell['$height='](cell_height);
          current_cell.$left(x);
          current_cell.$top(y);
          return (i = $rb_plus(i, 1));}, {$$s: self});}, {$$s: self});
      number_of_cells = $rb_times(nb_of_rows, nb_of_cols);
      if (!$truthy(exceptions)) {
        return nil
      };
      if ($truthy(exceptions['$[]']("columns_fusion"))) {
        self.$fusion($hash2(["columns"], {"columns": exceptions['$[]']("columns_fusion")}))
      };
      if ($truthy(exceptions['$[]']("rows_fusion"))) {
        self.$fusion($hash2(["rows"], {"rows": exceptions['$[]']("rows_fusion")}))
      };
      if ($truthy(exceptions['$[]']("columns_divided"))) {
        self.$divide($hash2(["columns"], {"columns": exceptions['$[]']("columns_divided")}))
      };
      if ($truthy(exceptions['$[]']("rows_divided"))) {
        return self.$divide($hash2(["rows"], {"rows": exceptions['$[]']("rows_divided")}))
      } else {
        return nil
      };
    }, -7);
    ...
    $def(self, '$matrix', function $$matrix(params) {
      ...
      cells_color_id = self.$color(cells_color).$id().$value();
      cells_shadow = cells_data['$[]']("particles").$delete("shadow");
      cells_shadow_id = self.$shadow(cells_shadow).$id().$value();
      ...
      $send(number_of_cells, 'times', [], function $$16(index){var self = $$16.$$s == null ? this : $$16.$$s, current_cell = nil;

        
        if (index == null) index = nil;
        current_cell = self.$grab(matrix_id).$box($hash2(["id"], {"id": "" + (matrix_id) + "_" + (index)}));
        the_matrix.$instance_variable_set("@cell_style", cells_data['$[]']("particles"));
    ...
    $def(self, '$add_columns', function $$add_columns(nb) {
      ...
      $send(new_nb_of_cells, 'times', [], function $$17(index){var self = $$17.$$s == null ? this : $$17.$$s, current_cell = nil;
        ...
        if ($truthy($rb_lt(index, prev_nb_of_cells))) {
          self.$grab("" + (self.$id().$value()) + "_" + (index)).$delete(true)
        };
    ...
    $def(self, '$add_rows', function $$add_rows(nb) {
      ...
      new_nb_of_cells = $rb_plus(prev_nb_of_cells, nb_of_cells_to_adds);
      $send(new_nb_of_cells, 'times', [], function $$18(index){var self = $$18.$$s == null ? this : $$18.$$s, current_cell = nil;
        if (self.cell_style == null) self.cell_style = nil;
    ...
    $def(self, '$resize', function $$resize(width, height) {
      ...
      self.$grab(self.$id().$value()).$width(width);
      self.$grab(self.$id().$value()).$height(height);
      return self.$format_matrix(self.$id(), self.matrix_width, self.matrix_height, self.rows, self.columns, self.margin, self.exceptions);
    });
    return $def(self, '$get_column_or_row', function $$get_column_or_row(length, num_columns, index, is_column) {
      ...
      if ($truthy(is_column)) {
        ...
        result = [];
        $send(Opal.Range.$new(0,num_rows, true), 'each', [], function $$19(row){
...
Opal.modules["atome/helpers/sanitizer"] = function(Opal) {/* Generated by Opal 1.7.1 */
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.7.1 */
  ...
  Opal.add_stubs('==,downcase,new_default_params,eval,eval_protection,[],default_params,current_user=,puts,app_identity,current_machine,current_user,current_server,new');
  ...
  self.$puts("current server: " + ($$('Universe').$current_server()));
  ...
  $$('Atome').$new($hash2(["color"], {"color": $hash2(["renderers", "id", "type", "red", "green", "blue", "alpha"], {"renderers": default_render, "id": "view_color", "type": "color", "red": 0.15, "green": 0.15, "blue": 0.15, "alpha": 1})}));
  $$('Atome').$new($hash2(["color"], {"color": $hash2(["renderers", "id", "type", "red", "green", "blue", "alpha"], {"renderers": default_render, "id": "shape_color", "type": "color", "red": 0.4, "green": 0.4, "blue": 0.4, "alpha": 1})}));
  $$('Atome').$new($hash2(["color"], {"color": $hash2(["renderers", "id", "type", "red", "green", "blue", "alpha"], {"renderers": default_render, "id": "box_color", "type": "color", "red": 0.5, "green": 0.5, "blue": 0.5, "alpha": 1})}));
  $$('Atome').$new($hash2(["color"], {"color": $hash2(["renderers", "id", "type", "red", "green", "blue", "alpha"], {"renderers": default_render, "id": "text_color", "type": "color", "red": 0.3, "green": 0.3, "blue": 0.3, "alpha": 1})}));
  $$('Atome').$new($hash2(["color"], {"color": $hash2(["renderers", "id", "type", "red", "green", "blue", "alpha"], {"renderers": default_render, "id": "circle_color", "type": "color", "red": 0.6, "green": 0.6, "blue": 0.6, "alpha": 1})}));
  $$('Atome').$new($hash2(["color"], {"color": $hash2(["renderers", "id", "type", "left", "top", "red", "green", "blue", "alpha", "diffusion"], {"renderers": default_render, "id": "matrix_color", "type": "color", "left": 0, "top": 0, "red": 0.7, "green": 0.7, "blue": 0.7, "alpha": 1, "diffusion": "linear"})}));
  return $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["renderers", "id", "type", "parents", "children", "attached", "left", "right", "top", "bottom", "width", "height", "overflow"], {"renderers": default_render, "id": "view", "type": "shape", "parents": ["user_view"], "children": [], "attached": ["view_color"], "left": 0, "right": 0, "top": 0, "bottom": 0, "width": "auto", "height": "auto", "overflow": "auto"})}));
};
